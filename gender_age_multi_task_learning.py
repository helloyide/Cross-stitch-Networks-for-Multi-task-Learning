...
def parse_args(argv):
    ...
    parser.add_argument("--lr", help="learning rate", default=0.0003)
    parser.add_argument("--n_epoch", help="number of epoch", default=900)
    parser.add_argument("--n_batch_size", help="mini batch size", default=128)
    parser.add_argument("--reg_lambda", help="L2 regularization lambda", default=1e-4)
